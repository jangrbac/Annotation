...
var mouseClick = {
 ...
 function mouseDown(element) {
	...
	mouseClick.DOWNx = element.pageX;
	mouseClick.DOWNy = element.pageY;
	console.log("DOWN: pageX:" + mouseClick.DOWNx + ", pageY:" + mouseClick.DOWNy);
};

function mouseUp(element) {
	// funkcija ki dobi koncne koordinate potega miske
	mouseClick.UPx = element.pageX;
	mouseClick.UPy = element.pageY;
	console.log("UP: pageX:" + mouseClick.UPx + ", pageY:" + mouseClick.UPy);
};
...
function getSelectionText() {
	...
	// call highlighting function to draw highlight
	highlighting();
};
...
function highlighting(){
	...
	var X = mouseClick.DOWNx;
	var Y = TOPpoint;
	var width = (mouseClick.UPx - mouseClick.DOWNx);
